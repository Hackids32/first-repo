...
else
{
    ...
    $update = $koneksi->query("UPDATE mstr_principle SET
                                PrincipleName = '$_POST[nama_principle]',
                                ManufactureCode = '$_POST[kode_manufaktur]',
                                ...
                                ModifiedAt = '$modify',
                                ModifiedBy = '$_SESSION[username]' WHERE PrincipleId = '$id'");
    if($update)
    {   
