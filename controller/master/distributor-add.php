                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>Tambah Distributor</h5>
                        </div>
                        <div class="ibox-content">
                            <form method="POST" action="distributor-simpan">   
                            <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="font-normal">Kode Distributor</label>
                                                    <div class="input-group">
                                                        <input type="text" name="kode_distributor" class="form-control" placeholder="Kode Distributor" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="font-normal">Nama Distributor</label>
                                                    <div class="input-group">
                                                        <input name="nama_distributor" type="text" class="form-control" placeholder="Nama Distributor" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="font-normal">Nama Official</label>
                                                    <div class="input-group">
                                                        <input name="nama_official" type="text" class="form-control" placeholder="Nama Official">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="alamat3" type="text" class="form-control" placeholder="Alamat 3">
                                                    </div>
                                                </div>
                                                <div class="form-group">
