                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="post" action="transaksipasien" id="formD" name="formD">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#myModal5"><i class="fa fa-search" aria-hidden="true"></i> Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Modal-->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Search Pasien</h4>
                                                ...
                                                <div class="modal-body">
                                                    <div class="table-responsive">
                                                        <table class="table2 table-striped table-sm" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">No</th>
                                                                    <th scope="col">Kartu Pasien</th>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="no_pasien" name="no_pasien" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="nama" name="nama_pasien" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="qty" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Qty" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="post" action="transaksipasien">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group" id="data_1">
                                            <label class="font-normal"><b>Tanggal</b></label>
                            ...
                            <form method="post" action="transaksipasien-proses-edit">
                                <div class="row">
                                    ...
                                    <table width="100%" class="table table-border">
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <!--<a href=""><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>-->
                                                    <a href="pasien-delete-<?php echo $row['TransDrugItemId']; ?>"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
                                                </td>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $row['EstablishCode']; ?></td>
                                                <td><?php echo $data['DrugsName']; ?></td>
                                        ...
                                        $totall = $total;
                                        ?>
                                        <form id="formD" name="formD" action="transaksipasien-simpan" method="post" enctype="multipart/form-data">
                                            <tr>
                                                <td colspan="8" align="right"><b>Total:</b></td>
                                                <td><input type="hidden" name="total" class="form-control" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" value="<?php echo $totall; ?>" readonly>
