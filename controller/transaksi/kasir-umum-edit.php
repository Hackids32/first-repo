...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
    ...
    $kueri = $koneksi->query("SELECT * FROM trxn_saledrugs WHERE SalesDrugsCode = '$_GET[id]'");
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="post" action="transaksiumum" id="formD" name="formD">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="nama" name="nama_pasien" placeholder="Nama Pasien" class="form-control" onkeyup="saveValue(this);" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="id_dokter" id="id_dokter" class="form-control select2_demo_2" onkeyup="saveValue(this);" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="hp" name="telepon" class="form-control" placeholder="No. Telepon" onkeyup="saveValue(this);">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="umum-regdel-<?php echo $k['SalesDrugsCode']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="post" action="transaksi-proses">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2_demo_2" name="kode_obat" tabindex="1">
                                                    <?php
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="qty" tabindex="2" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Qty" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="biaya_jasa" tabindex="3" onkeypress="return hanyaAngka(event)" class="form-control" value="0" placeholder="Biaya Jasa">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-normal"><b>Diskon (Rupiah)</b></label>
                                            <div class="input-group">
                                                <input type="text" name="diskon" tabindex="4" onkeypress="return hanyaAngka(event)" class="form-control" value="0" placeholder="Diskon">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <button type="submit" tabindex="5" name="proses" value="add" class="btn btn-primary tombol-simpan"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table width="100%" class="table table-border">
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <!--<a href=""><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>-->
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="post" action="transaksiumum">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group" id="data_1">
                                            <label class="font-normal"><b>Tgl. Register</b></label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" placeholder="2022-01-01" value="<?php echo $tgl; ?>" name="tgl_input" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-normal"><b>Nama Pasien</b></label>
                                            <div class="input-group">
                                                <input type="text" value="<?php echo $k['CustomerName']; ?>" name="nama_pasien" class="form-control" placeholder="Nama Pasien" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-normal"><b>No. Resep</b></label>
                                            <div class="input-group">
                                                <input type="text" name="no_resep" class="form-control" value="<?php echo $k['DrugsReceiveNumb']; ?>" placeholder="No. Resep Dokter" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-normal"><b>Pilih Dokter</b></label>
                                            <div class="input-group">
                                                <select name="id_dokter" class="form-control select2_demo_2" readonly>
                                                    <option value="" selected>-- Pilih Dokter --</option>
                                                    <?php
                                                    $dokter = $koneksi2->query("SELECT * FROM mstr_dokter ORDER BY nama ASC");
                                                    while ($d = mysqli_fetch_array($dokter)) {
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="font-normal">&nbsp;</label>
                                            <div class="input-group">
                                                <button class="btn btn-primary" type="submit" name="proses" value="header" disabled><i class="fa fa-check" aria-hidden="true"></i> Revisi Invoice</button>
                                                &nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="umum-regdel-<?php echo $k['SalesDrugsCode']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form method="post" action="transaksi-proses-edit">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label class="font-normal"><b>&nbsp;</b></label><br>
                                            <div class="input-group">
                                                <button type="submit" name="proses" value="add" tabindex="5" class="btn btn-primary tombol-simpan"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="formD" name="formD" action="transaksi-simpan" method="post" enctype="multipart/form-data">
                                        <table width="100%" class="table table-border">
                                            <tr>
                                                <th><b>#</b></th>
                                                <th><b>No.</b></th>
                                            ...
                                            $no = 1;
                                            $total = 0;
                                            $detail = $koneksi->query("SELECT * FROM rltn_transdrugsitem WHERE SalesDrugsCode = '$k[SalesDrugsCode]'  ORDER BY TransDrugItemId ASC");
                                            while ($row = mysqli_fetch_array($detail)) {
                                                $detail2 = $koneksi->query("SELECT EstablishCode, DrugsName FROM mstr_obat WHERE EstablishCode = '$row[EstablishCode]'");
                                                $data = mysqli_fetch_array($detail2)
                                            ?>
                                                <tr>
                                                    <td>
                                                        <!--<a href=""><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>-->
                                                        <a href="kasir-delete-<?php echo $row['TransDrugItemId']; ?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $row['EstablishCode']; ?></td>
                                                    <td><?php echo $data['DrugsName']; ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><select name="delivery" onchange="OnChange(this.value)" onKeyPress="return isNumberKey(event)" class="form-control">
                                                        ...
                                                        ?>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '15000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '20000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000" selected>Rp. 20.000</option>
                                                            <option value="25000">Rp. 25.000</option>
                                                            <option value="30000">Rp. 30.000</option>
                                                            <option value="35000">Rp. 35.000</option>
                                                            <option value="40000">Rp. 40.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '25000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            <option value="25000" selected>Rp. 25.000</option>
                                                            <option value="30000">Rp. 30.000</option>
                                                            <option value="35000">Rp. 35.000</option>
                                                            <option value="40000">Rp. 40.000</option>
                                                            <option value="45000">Rp. 45.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '30000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            <option value="25000">Rp. 25.000</option>
                                                            <option value="30000" selected>Rp. 30.000</option>
                                                            <option value="35000">Rp. 35.000</option>
                                                            <option value="40000">Rp. 40.000</option>
                                                            <option value="45000">Rp. 45.000</option>
                                                            <option value="50000">Rp. 50.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '35000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            <option value="25000">Rp. 25.000</option>
                                                            <option value="30000">Rp. 30.000</option>
                                                            <option value="35000" selected>Rp. 35.000</option>
                                                            <option value="40000">Rp. 40.000</option>
                                                            <option value="45000">Rp. 45.000</option>
                                                            <option value="50000">Rp. 50.000</option>
                                                            <option value="55000">Rp. 55.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '40000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="30000">Rp. 30.000</option>
                                                            <option value="35000">Rp. 35.000</option>
                                                            <option value="40000" selected>Rp. 40.000</option>
                                                            <option value="45000">Rp. 45.000</option>
                                                            <option value="50000">Rp. 50.000</option>
                                                            <option value="55000">Rp. 55.000</option>
                                                            <option value="60000">Rp. 60.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '45000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="35000">Rp. 35.000</option>
                                                            <option value="40000">Rp. 40.000</option>
                                                            <option value="45000" selected>Rp. 45.000</option>
                                                            <option value="50000">Rp. 50.000</option>
                                                            <option value="55000">Rp. 55.000</option>
                                                            <option value="60000">Rp. 60.000</option>
                                                            <option value="65000">Rp. 65.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '50000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '55000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="45000">Rp. 45.000</option>
                                                            <option value="50000">Rp. 50.000</option>
                                                            <option value="55000" selected>Rp. 55.000</option>
                                                            <option value="60000">Rp. 60.000</option>
                                                            <option value="65000">Rp. 65.000</option>
                                                            <option value="70000">Rp. 70.000</option>
                                                            <option value="75000">Rp. 75.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '60000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="50000">Rp. 50.000</option>
                                                            <option value="55000">Rp. 55.000</option>
                                                            <option value="60000" selected>Rp. 60.000</option>
                                                            <option value="65000">Rp. 65.000</option>
                                                            <option value="70000">Rp. 70.000</option>
                                                            <option value="75000">Rp. 75.000</option>
                                                            <option value="80000">Rp. 80.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '65000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="55000">Rp. 55.000</option>
                                                            <option value="60000">Rp. 60.000</option>
                                                            <option value="65000" selected>Rp. 65.000</option>
                                                            <option value="70000">Rp. 70.000</option>
                                                            <option value="75000">Rp. 75.000</option>
                                                            <option value="80000">Rp. 80.000</option>
                                                            <option value="85000">Rp. 85.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '70000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="60000">Rp. 60.000</option>
                                                            <option value="65000">Rp. 65.000</option>
                                                            <option value="70000" selected>Rp. 70.000</option>
                                                            <option value="75000">Rp. 75.000</option>
                                                            <option value="80000">Rp. 80.000</option>
                                                            <option value="85000">Rp. 85.000</option>
                                                            <option value="90000">Rp. 90.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '75000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="65000">Rp. 65.000</option>
                                                            <option value="70000">Rp. 70.000</option>
                                                            <option value="75000" selected>Rp. 75.000</option>
                                                            <option value="80000">Rp. 80.000</option>
                                                            <option value="85000">Rp. 85.000</option>
                                                            <option value="90000">Rp. 90.000</option>
                                                            <option value="95000">Rp. 95.000</option>
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '80000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '85000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="75000">Rp. 75.000</option>
                                                            <option value="80000">Rp. 80.000</option>
                                                            <option value="85000" selected>Rp. 85.000</option>
                                                            <option value="90000">Rp. 90.000</option>
                                                            <option value="95000">Rp. 95.000</option>
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '90000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="80000">Rp. 80.000</option>
                                                            <option value="85000">Rp. 85.000</option>
                                                            <option value="90000" selected>Rp. 90.000</option>
                                                            <option value="95000">Rp. 95.000</option>
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '95000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
                                                            ...
                                                            <option value="85000">Rp. 85.000</option>
                                                            <option value="90000">Rp. 90.000</option>
                                                            <option value="95000" selected>Rp. 95.000</option>
                                                            <option value="100000">Rp. 100.000</option>
                                                        <?php
                                                        } elseif ($k['DeliveryPayment'] == '100000') {
                                                        ?>
                                                            <option value="0">Rp. 0</option>
                                                            <option value="15000">Rp. 15.000</option>
                                                            <option value="20000">Rp. 20.000</option>
