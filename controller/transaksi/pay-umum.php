...
?>
    ...
    <body>
                                    ...
                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="totbay" name="totbay" readonly>
                                                                    <input type="hidden" class="form-control" id="totbay2" name="totbay2" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                        ...
                                        <script type="text/javascript" language="Javascript">
                                            function jumlah() {
                                                ...
                                                var kembalii = parseInt(totbay) - parseInt(jumbay);
                                                if (kembalii < 0) {
                                                    var kembali = parseInt(jumbay) - parseInt(totbay);
                                                } else {
        ...
        <script>
            ...
            function update() {
                $.ajax({
                    url: 'data-umum.php?id=<?php echo $_GET['id']; ?>',
                    type: 'get',
