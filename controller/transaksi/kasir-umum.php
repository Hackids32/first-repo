                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="id_dokter" id="id_dokter" class="form-control select2_demo_2" onkeyup="saveValue(this);">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="qty" tabindex="2" class="form-control" placeholder="Qty" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <a href="kasir-delete-<?php echo $row['TransDrugItemId']; ?>"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
                                                </td>
                                                <td><?php echo $no; ?></td>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#myModal').on('show.bs.modal', function(e) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: 'model/transaksi/detail-umum.php',
                        data: 'rowid=' + rowid,
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-normal"><b>Nama Pasien</b></label>
                                            <div class="input-group">
                                                <input type="text" value="<?php echo $k['CustomerName']; ?>" name="nama_pasien" class="form-control" placeholder="Nama Pasien" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-normal"><b>Pilih Dokter</b></label>
                                            <div class="input-group">
                                                <select name="id_dokter" class="form-control select2_demo_2">
                                                    <option value="" selected>-- Pilih Dokter --</option>
                                                    <?php
                                                    $dokter = $koneksi2->query("SELECT * FROM mstr_dokter ORDER BY nama ASC");
                                                    while ($d = mysqli_fetch_array($dokter)) {
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="font-normal"><b>No. Telpon Pasien</b></label>
                                            <div class="input-group">
                                                <input type="text" name="telepon" class="form-control" placeholder="No. Telepon" value="<?php echo $k2['hp']; ?>">
                                            </div>
                                        </div>
                                    </div>
