...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=$_SERVER[PHP_SELF]?route=$_GET[route]&halaman=$i>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halprodukterbaru'])){
	$posisi=0;
	$_GET['halprodukterbaru']=1;
}
else{
	$posisi = ($_GET['halprodukterbaru']-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halprodukterbaru-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// class paging untuk halaman produk (menampilkan semua produk terlaris) 
class Paging6{
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halprodukterlaris'])){
	$posisi=0;
	$_GET['halprodukterlaris']=1;
}
else{
	$posisi = ($_GET['halprodukterlaris']-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halprodukterlaris-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halsubkategori'])){
	$posisi=0;
	$_GET['halsubkategori']=1;
}
else{
	$posisi = ($_GET['halsubkategori']-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halsubkategori-$_GET[id]-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
